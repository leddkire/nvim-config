...
telescope.load_extension("local_declarations")
...
--- end)
vim.keymap.set('n', '<leader>lg', builtin.git_bcommits, {desc= 'Telescope buffer commits'})
vim.keymap.set('v', '<leader>lg', builtin.git_bcommits_range, {desc= 'Telescope buffer commits in selected range'})
vim.keymap.set('n', '<leader>lG', builtin.git_commits, {desc= 'Telescope commits'})
...
vim.keymap.set('n', '<leader>f1', extensions.local_declarations.local_declarations, { desc = 'Telescope find all local declarations in the current buffer' })
